            ...
            <div
                ...
                <div
                    ...
                    <div class="ask-biigle-bubble">
                        ...
                        <button
                            v-if="hasAdminEmail && message.role === 'assistant' && message.content"
                            type="button"
            ...
            <div class="panel-footer ask-biigle-footer">
                ...
                <div class="ask-biigle-actions">
                    ...
                    <a
                        ...
                        :href="contactMailto"
                        title="Contact the BIIGLE administrators by email"
                        >
                        <i class="fa fa-user"></i> Contact a human
                    </a>
...
// The mails of the chat are sent to the admin_email of biigle/core, which the
// navbarHelpItemTop view declares for the JS. $require() returns an empty object if it
// was not declared.
function adminEmail() {
...
export default {
    ...
    computed: {
        // Both buttons that open the mail client need an address to write to.
        hasAdminEmail() {
        ...
        // An empty mail, in contrast to the report, so it needs no method.
        contactMailto() {
            return `mailto:${adminEmail()}?subject=${encodeURIComponent(CONTACT_SUBJECT)}`;
        },
        requestHistory() {
    ...
    methods: {
        ...
        reportMessage(index) {
            ...
            window.location.href = `mailto:${adminEmail()}?subject=${encodeURIComponent(REPORT_SUBJECT)}&body=${encodeURIComponent(body)}`;
        },
