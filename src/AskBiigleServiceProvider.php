...
class AskBiigleServiceProvider extends ServiceProvider
{
    ...
    {
        $this->loadViewsFrom(__DIR__ . "/resources/views", "askbiigle");
        ...
        $this->publishes(
            [
                __DIR__ . "/public" => public_path("vendor/askbiigle"),
            ],
            "public",
        );
    }
    ...
    {
        $this->mergeConfigFrom(__DIR__ . "/config/askbiigle.php", "askbiigle");
    }
}
